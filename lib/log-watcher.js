 ...
 *                   emit an error, but will be added to the previous log entry. Useful to support logs with stacktraces,
 *                   and any other kink of dump.
        ...
        lines.forEach(function(line) {
          ...
          if (fieldsValues === null) {
            ...
            if (self.allowPatternViolations && logs.length) {
              ...
              return self.emit('error', new Error('LogWatcher: log line does not follow the given pattern: ' + line));
            }
          }
